  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className={`font-display font-bold text-2xl tracking-widest flex items-center gap-2 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
          <div className="w-8 h-8 border-2 border-blue-500 rounded-br-lg rounded-tl-lg flex items-center justify-center shadow-[0_0_15px_rgba(59,130,246,0.5)]">
            <div className={`w-2 h-2 rounded-full animate-pulse ${theme === 'dark' ? 'bg-white' : 'bg-blue-500'}`}></div>
          </div>
          FSO SYSTEM
        </div>
